...
export const COMPARE_COLORS = [TERTIARY_BLUE, TERTIARY_PINK, TERTIARY_YELLOW];
export const BANNER_IMAGE_URL = "https://www.metropol.gov.co/BannerInternas/Observatorio.jpg";